              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center mt-2 sm:mt-0">
                  <a
                    ...
                    className="w-full sm:w-auto px-2.5 sm:px-3 py-1 sm:py-1.5 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 text-[10px] sm:text-xs font-medium rounded-lg transition-colors flex items-center justify-center mr-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  {video.usage !== undefined && (
                    <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-emerald-500/10 text-emerald-300 text-[10px] sm:text-xs font-medium rounded-lg flex items-center mr-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-1.5"
                        viewBox="0 0 20 20"
