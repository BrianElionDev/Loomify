              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 mt-2 sm:mt-0">
                  ...
                  {video.usage !== undefined && (
                    <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-emerald-500/10 text-emerald-300 text-[10px] sm:text-xs font-medium rounded-lg flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-1.5"
                        viewBox="0 0 20 20"
                  ...
                  {video.project && (
                    <div className="hidden sm:flex px-2.5 py-1 text-xs font-medium bg-indigo-500/10 text-indigo-300 rounded-md items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    onClick={onClose}
                    className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-colors"
                    aria-label="Close"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
