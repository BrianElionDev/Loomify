...
const submitLoomUrl = async (loomUrl: string) => {
  try {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <motion.div
        ...
        className="bg-gradient-to-r from-slate-900 to-slate-800/80 p-6 rounded-xl border border-slate-700/40 shadow-lg"
      >
        <div className="flex items-center mb-6">
          <div className="h-10 w-10 bg-indigo-500/20 rounded-md flex items-center justify-center mr-4">
            <svg
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="py-3 pl-10 pr-4 bg-white/5 border border-white/10 rounded-lg text-white/80 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                required
              />
            </div>
            <p className="mt-2 text-sm text-white/50">
              Paste the full Loom share URL (e.g.,
